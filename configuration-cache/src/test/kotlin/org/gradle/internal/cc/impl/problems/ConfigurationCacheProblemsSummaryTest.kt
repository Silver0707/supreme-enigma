...
//        )
    ...
    private fun buildLogicProblem(location: String, message: String, exception: Throwable? = null) = buildLogicProblem(
        buildLogicUserCodeSourceTrace(location),
        message,
        exception
    )

    private fun buildLogicProblem(propertyTrace: PropertyTrace, message: String, exception: Throwable? = null) = PropertyProblem(
        propertyTrace,
        StructuredMessage.build { text(message) },
        exception
    )

    private fun buildLogicUserCodeSourceTrace(displayName: String): PropertyTrace.BuildLogic =
